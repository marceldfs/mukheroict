<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group{{ $errors->has('nuit') ? ' has-error' : '' }}">
            ...
            {!! Form::text('nuit',$funcionario->nuit,['class' => 'form-control ', 'id' => 'nuit', 'type' => 'number', 'readonly' => 'true']) !!}
            @if ($errors->has('nuit'))
        ...
        <div class="form-group{{ $errors->has('numero_inss') ? ' has-error' : '' }}">
            ...
            {!! Form::text('numero_inss',$funcionario_efectivo->numero_inss,['class' => 'form-control ', 'id' => 'numero_inss','type' => 'number',
        ...
        <div class="form-horizontal">
            <div class="form-group col-lg-6">
                ...
                {!! Form::select('tipo_documento', $tipos_documento, $funcionario->tipo_documento, ['class' => 'form-control ', 'id' => 'tipo_documento']) !!}
            </div>	
            <div class="form-group col-lg-6 pull-right{{ $errors->has('numero_documento') ? ' has-error' : '' }}">
                ...
                {!! Form::text('numero_documento',$funcionario->numero_documento,['class' => 'form-control ', 'id' => 'numero_documento', 'readonly' => 'true']) !!}
        ...
        <div class="form-horizontal">
            <div class="form-group col-lg-6">
                ...
                {!! Form::select('tipo_carta_conducao', $tipos_carta, $funcionario_efectivo->tipo_carta_conducao, ['class' => 'form-control ', 'id' => 'tipo_carta_conducao']) !!}
            </div>	
            <div class="form-group col-lg-6 pull-right">
                {!! Form::label('lncarta','Numero da Carta de Condu&ccedil;&atilde;o:', ['for' => 'numero_carta_conducao'])  !!}
                {!! Form::text('numero_carta_conducao',$funcionario_efectivo->numero_carta_conducao,['class' => 'form-control ', 'id' => 'numero_carta_conducao', 'readonly' => 'true']) !!}
            </div>
        </div>
    </div>	
</div>  