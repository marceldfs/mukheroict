...
<div class="container mukheroHack2">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="{{ url('criaUtilizador/') }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('GET') }}
                    
                <button type="submit" id="create-user" class="btn btn-danger">
                    <i class="fa fa-btn fa-trash"></i>Criar
                </button>
            </form>
            <table class="table table-striped task-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-text">
                            <div>{{ $utilizador->TipoUtilizadorUser($utilizador->tipo_utilizador)->descricao}}</div>
                        </td>
